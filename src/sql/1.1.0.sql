USE [kihdb]
GO
/****** Object:  Table [dbo].[lab_producer]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[iupaccode]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[instrument]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[citizen]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[citizen](
	...
	[in_personalization_index] [bit] NOT NULL,
...
GO
/****** Object:  Table [dbo].[role]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[permission]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[audit_log_controller_entity]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[users]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[xdsmetadata]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[xdsdocument]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[user_role]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[self_monitoring_sample]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[self_monitoring_sample](
	...
	[xds_conversion_started] [bit] NOT NULL DEFAULT 0,
	[xds_document_uuid] [nvarchar](1024) NULL,
	[xds_registered_in_registry] [bit] NOT NULL DEFAULT 0,
PRIMARY KEY CLUSTERED
(
	[id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
...
GO
/****** Object:  Table [dbo].[role_permission]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[audit_log_entry]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[laboratory_report]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[audit_log_parameter]    Script Date: 01/23/2014 11:23:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  ForeignKey [FK40704C53F84F8915]    Script Date: 01/23/2014 11:23:27 ******/
...
GO
/****** Object:  ForeignKey [FK4D351F0AF5DB4508]    Script Date: 01/23/2014 11:23:27 ******/
...
GO
/****** Object:  ForeignKey [FKE2DD6340145CCC91]    Script Date: 01/23/2014 11:23:27 ******/
...
GO
/****** Object:  ForeignKey [FKE2DD6340344CE08C]    Script Date: 01/23/2014 11:23:27 ******/
...
GO
/****** Object:  ForeignKey [FKE2DD634072DCB95D]    Script Date: 01/23/2014 11:23:27 ******/
...
GO
/****** Object:  ForeignKey [FKE2DD6340BF822EE4]    Script Date: 01/23/2014 11:23:27 ******/
...
GO
/****** Object:  ForeignKey [FKBD40D5383C5E905D]    Script Date: 01/23/2014 11:23:27 ******/
...
GO
/****** Object:  ForeignKey [FKBD40D538FBCCF93D]    Script Date: 01/23/2014 11:23:27 ******/
...
GO
/****** Object:  ForeignKey [FK3F1EEB4EA5548A97]    Script Date: 01/23/2014 11:23:27 ******/
...
GO
/****** Object:  ForeignKey [FK143BF46AFBCCF93D]    Script Date: 01/23/2014 11:23:27 ******/
...
GO
/****** Object:  ForeignKey [FK143BF46AA0F7BD1D]    Script Date: 01/23/2014 11:23:27 ******/
...
GO
/****** Object:  ForeignKey [FK5FEA922FB38CFF7]    Script Date: 01/23/2014 11:23:27 ******/
ALTER TABLE [dbo].[xdsdocument]  WITH CHECK ADD  CONSTRAINT [FK5FEA922FB38CFF7] FOREIGN KEY([metadata_id])
REFERENCES [dbo].[xdsmetadata] ([id])
GO
ALTER TABLE [dbo].[xdsdocument] CHECK CONSTRAINT [FK5FEA922FB38CFF7]
GO
