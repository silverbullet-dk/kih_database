...
@XmlRootElement(name = "CreateMonitoringResponseMessage", namespace = "urn:oio:medcom:chronicdataset:monitoring:1.0.0")
public class CreateMonitoringResponseMessage {
